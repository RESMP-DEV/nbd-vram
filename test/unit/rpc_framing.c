/* test/unit/rpc_framing.c - local copy for PR1 foundation.
 *
 * This is the same implementation as sidecar/daemon/rpc_framing.c. It
 * lives here so PR1 (foundation) can ship RPC framing tests without
 * depending on PR4 (sidecar). When PR4 lands, the Makefile prefers
 * sidecar/daemon/rpc_framing.c and this local copy becomes redundant;
 * it is removed in PR4.
 */
#include <stdint.h>
#include <stdio.h>
#include <stdlib.h>
